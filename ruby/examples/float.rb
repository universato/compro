...
# p Float.f32(0b01000010111011010100000000000000) #=>  118.625
# p Float.f32(0b11000010111011010100000000000000) #=> -118.625
# p Float.f32(0b00000000000000000000000000000000) #=> 0.0
# p Float.f32(0b01111111100000000000000000000000) #=> Infinity
p Float.f32(0b00000000010000000000000000000000) # ??

# p 0b00000000010000000000000000000000 #=> 4194304
# p 0b00000000010000000000000000000000.bit_length #=> 23
